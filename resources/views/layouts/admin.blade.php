...
<head>
    ...
    <style>
        ...
        .mode-toggle:hover { background: var(--ink-2); color: var(--text); border-color: var(--border-2); }
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            font-family: @if(app()->getLocale() == 'km') 'Kantumruy Pro', @endif 'DM Sans', sans-serif;
            background-color: var(--ink);
            color: var(--text);
            -webkit-font-smoothing: antialiased;
            height: 100vh;
            overflow: hidden;
            line-height: @if(app()->getLocale() == 'km') 1.8 @else 1.5 @endif;
            font-size: @if(app()->getLocale() == 'km') 15px @else 14px @endif;
        ...
        .sidebar {
            width: var(--sidebar-w);
            flex-shrink: 0;
            background: #090a0f; /* Deeper, more premium dark */
        ...
        html.light .nav-icon { background: rgba(0,0,0,0.03); }
        ...
        .logout-btn:hover { background: rgba(240,82,82,0.1); color: var(--red); border-color: rgba(240,82,82,0.3); }
        ...
        .page-breadcrumb .sep { color: var(--accent); margin: 0 5px; }
        ...
        .search-input:focus { border-color: rgba(79,110,247,0.5); width: 300px; }
        ...
        .icon-btn:hover { background: rgba(255,255,255,0.06); color: var(--text); border-color: var(--border-2); }
        ...
        .content-area::-webkit-scrollbar-thumb { background: var(--ink-3); border-radius: 10px; }
        ...
        .toast.success .toast-icon { background: rgba(34,201,122,0.12); color: var(--green); }
        .toast.error .toast-icon   { background: rgba(240,82,82,0.12);  color: var(--red);   }
        ...
        .toast.success .toast-type { color: var(--green); }
        .toast.error .toast-type   { color: var(--red);   }
...
<div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav-body">
            <!-- Overview -->
            <div class="nav-section-label">@lang('admin.overview')</div>
            ...
            <!-- Catalog -->
            <div class="nav-section-label" style="margin-top:20px">@lang('admin.catalog')</div>
            ...
            <!-- Commerce -->
            <div class="nav-section-label" style="margin-top:20px">@lang('admin.commerce')</div>
        ...
        <div class="sidebar-footer">
            <div class="user-card">
                ...
                <div style="min-width:0">
                    ...
                    <div class="user-role">@lang('admin.administrator')</div>
                </div>
                <form action="{{ route('admin.logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="logout-btn" title="@lang('admin.sign_out')">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
    ...
    <main class="main">
        ...
        <header class="topbar">
            ...
            <div class="topbar-actions">
                <!-- Language Switcher -->
                <div class="flex items-center gap-1 bg-ink p-1 rounded-xl border border-border">
...
<script>
    ...
    function toggleMode() {
        ...
        // Fire an event so page-level charts can re-render
